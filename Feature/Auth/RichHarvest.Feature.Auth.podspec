#
# Be sure to run `pod lib lint RichHarvest.Feature.Auth.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'RichHarvest.Feature.Auth'
  s.version          = '0.1.0'
  ...
  s.resource_bundles = {
    'RichHarvest.Feature.Auth' => ['Sources/Assets/**/*']
  }
